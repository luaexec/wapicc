...
public:
	...
	void TraceLine( const vec3_t& src, const vec3_t& dst, int mask, Player* entity, int collision_group, CGameTrace* trace );

	void TraceHull( const vec3_t& src, const vec3_t& dst, const vec3_t& mins, const vec3_t& maxs, int mask, Player* entity, int collision_group, CGameTrace* trace );
