...
void Chams::init() {
	...
	std::ofstream("csgo\\materials\\animchams.vmt") << R"#("VertexLitGeneric" 
	{
	...
	m_materials.push_back(g_csgo.m_material_system->FindMaterial(XOR("animchams"), XOR("Model textures")));
