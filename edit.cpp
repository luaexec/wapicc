...
void Edit::draw( ) {
	...
	// box outline.
	render::rect( p.x + EDIT_X_OFFSET, p.y + 15, m_w - EDIT_X_OFFSET, EDIT_BOX_HEIGHT, { 208,208,208, m_parent->m_alpha } );

	// inner blob
	// todo; gradient?
	render::rect_filled( p.x + EDIT_X_OFFSET + 1, p.y + 15 + 1, m_w - EDIT_X_OFFSET - 2, EDIT_BOX_HEIGHT - 2, { 208,208,208, m_parent->m_alpha } );
