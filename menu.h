...
public:
	void init( ) {
		...
		RegisterElement( &knifebot, 1 );

		zeusbot.setup( XOR( "aimbot with taser" ), XOR( "zeusbot" ) );
		RegisterElement( &zeusbot, 1 );
		...
		hitchance_amount.setup( "", XOR( "hitchance_amount" ), 0.f, 100.f, false, 0, 50.f, 1.f, XOR( L"%" ) );
		...
		accuracy_boost_amount.setup( "accuracy boost", XOR( "accuracy_boost_amount" ), 0.f, 100.f, true, 0, 60.f, 1.f, XOR( L"%" ) );
		accuracy_boost_amount.AddShowCallback( callbacks::IsConfigMM );
		accuracy_boost_amount.AddShowCallback( callbacks::IsHitchanceOn );
		RegisterElement( &accuracy_boost_amount, 1 );
